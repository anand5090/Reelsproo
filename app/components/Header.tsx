              ...
              >
                {session ? (
                  <>
                    ...
                    <li>
                      <button
                        ...
                        className="px-4 py-2 text-error font-semibold hover:bg-base-200 w-full text-left"
                      >
                        Sign Out
                      </button>
                    </li>
                  ...
                  <li className="px-[10px]">
                    <Link
                      href="/login"
                      className="block w-full px-4 py-2 text-center text-white bg-amber-500 rounded-lg hover:bg-blue-700 transition duration-300"
                      onClick={() =>
